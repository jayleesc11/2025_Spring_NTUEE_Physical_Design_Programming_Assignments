...
class Module {
  public:
    ...
    Rectangle rectangle() const { return Rectangle(_x, _y, _x + _width, _y + _height); }  // module rectangle

    Orient orient() const { return _orient; }
    string orientString() const {
    ...
    Pin &pin(unsigned index) const { return *_pPins[index]; }
