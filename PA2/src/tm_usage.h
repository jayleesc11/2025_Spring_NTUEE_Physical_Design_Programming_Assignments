...
struct TmStat {
    long vm_size;  // in kilobytes
    long vm_peak;  // in kilobytes
    long vm_diff;  // in kilobytes
    long r_time;   // real time in micro seconds
    long u_time;   // user time in micro seconds
    long s_time;   // system time in micro seconds
};
...
//     cout <<"user time: " << stat.u_time / 1000000.0 << "s" << endl; // print period user time in seconds
//     cout <<"system time: " << stat.s_time / 1000000.0 << "s" << endl; // print period systemtime in seconds
//     cout <<"user+system time:" << (stat.u_time + stat.s_time) / 1000000.0 << "s" << endl;
//
//     // do something...
//
//     tmusg.getTotalUsage(stat);
//     cout << stat.vm_size / 1024.0 << "MB" << endl; // print current memory
//     cout << stat.vm_peak / 1024.0 << "MB" << endl; // print peak memory
// **************************************************************************
